...
<body>
	...
	<nav>
		<a href="Dilki/index2.jsp">Home</a> <a href="Pradeepa/add_book.jsp">Manage
			Book Inventory</a> <a href="Dilki/index.jsp">Timetables</a> <a href="">Courses</a>
	</nav>
	...
	<a href="${Userdelete}"> <input type="submit" name="delete"
